...
class TurnValidator:
    ...
    def is_shooting_leagal(self, amazona_pos, target_pos):
        ...
        try:
            ...
            if (destination_x < board_size and destination_y < board_size):
                if (self.is_horizontal_valid_shooting(amazona_pos.dest_x, amazona_pos.y, target_pos.x, target_pos.y)
                    or self.is_vertical_valid_shooting(amazona_pos.dest_x, amazona_pos.y, target_pos.x, target_pos.y) 
                    or self.is_diagonal_valid_shooting(amazona_pos.dest_x, amazona_pos.y, target_pos.x, target_pos.y)):
                    return True
