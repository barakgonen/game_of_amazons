...
class TurnValidator:
    ...
    def is_shooting_leagal(self, amazona_pos, target_pos):
        ...
        try:
            ...
            if (destination_x < board_size and destination_y < board_size):
                if (self.is_horizontal_valid_shooting(origin_x, origin_y, destination_x, destination_y)
                    or self.is_vertical_valid_shooting(origin_x, origin_y, destination_x, destination_y) 
                    or self.is_diagonal_valid_shooting(origin_x, origin_y, destination_x, destination_y)):
                    return True
